package studio.trc.bungee.liteannouncer.message.color;
...
import studio.trc.bungee.liteannouncer.message.tag.TagContentExtractor;
import studio.trc.bungee.liteannouncer.message.tag.TagContentInfo;
