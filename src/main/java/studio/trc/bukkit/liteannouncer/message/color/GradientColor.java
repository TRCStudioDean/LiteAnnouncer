package studio.trc.bukkit.liteannouncer.message.color;
...
import studio.trc.bukkit.liteannouncer.message.tag.TagContentExtractor;
import studio.trc.bukkit.liteannouncer.message.tag.TagContentInfo;
