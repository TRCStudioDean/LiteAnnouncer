...
public class MessageUtil
{
    ...
    public static String toPlaceholderAPIResult(String text, CommandSender sender) {
        return PluginControl.usePlaceholderAPI() && sender instanceof Player ? ChatColor.translateAlternateColorCodes('&', PlaceholderAPI.setPlaceholders((Player) sender, text)) : ChatColor.translateAlternateColorCodes('&', text);
    }
